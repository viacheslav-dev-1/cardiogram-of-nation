import info from './parts/info-part/info-part.html'
import zero from './parts/zero-part/zero-part.html'
import video from './parts/video-part/video-part.html'
...
export const menuConfig = [
    ...
    },
    {
        ...
        content: video,
        extraBindings: [
            { anchor: '#videoDate', content: '24 лют. 2023 р.' },
            { anchor: '#videoDescription', content: 'Впродовж місяця ми дуже поглиблено вивчали ІПсО. Слід зазначити, що ворог змінив підхід. Зараз часто ІПсО відбуваються зі складним нашаруванням. Що це значить та як працює - розбираю.' },
            { anchor: '#videoContainer iframe', prop: 'src', content: 'https://www.youtube.com/embed/vysz3M0WdUM' }
        ]
    },
    {
        ...
        content: video,
        extraBindings: [
            { anchor: '#videoDate', content: '2 лют. 2023 р.' },
            { anchor: '#videoDescription', content: 'Зрадо**б - це філософія. Це одвічна школа життя. Це як храм Шаолінь. Тільки ху***ий. Шо ж, якшо ви починаючий зрадо**б - це відео для вас. Як правильно ї**ть зраду шоб не зійти зі шляху зрадо**ба. Чим вони відрізняються і які їх види.' },
            { anchor: '#videoContainer iframe', prop: 'src', content: 'https://www.youtube.com/embed/yTKnVF5bOPQ' }
        ]
    },
    {
        ...
        content: video,
        extraBindings: [
            { anchor: '#videoDate', content: '30 вер. 2022 р.' },
            { anchor: '#videoDescription', content: 'Іноді мені здається, що ці стани, які ми аналізуємо, не сприймаються серйозно і для когось це просто слова. Але всі ці назви станів мають дійсно психологічну (а іноді і медичну) класифікацію. Гнів має 4 різних рівні. І сьогодні Українці відчувають четвертий рівень.' },
            { anchor: '#videoContainer iframe', prop: 'src', content: 'https://www.youtube.com/embed/b6O68b1ms34' }
        ]
    },
    {
        ...
        content: video,
        extraBindings: [
            { anchor: '#videoDate', content: '18 трав. 2022 р.' },
            { anchor: '#videoDescription', content: 'Як літають? Шо роблять? В чому цінність і небезпека? Про дрони у цій війні вже багато сказали, зняли, розповіли. Але такого контенту багато не буває.' },
            { anchor: '#videoContainer iframe', prop: 'src', content: 'https://www.youtube.com/embed/vw69JmBSN0E' }
        ]
    },
    {
        title: 'Lend lease',
        ...
        content: video,
        extraBindings: [
            { anchor: '#videoDate', content: '10 трав. 2022 р.' },
            { anchor: '#videoDescription', content: 'Що таке ленд-ліз? Чому на ньому спекулюють і залякують? На які точки давлять ІПсО, щоб дестабілізувати українців?' },
            { anchor: '#videoContainer iframe', prop: 'src', content: 'https://www.youtube.com/embed/En82-TB_d-s' }
        ]
    },
    {
        ...
        content: video,
        extraBindings: [
            { anchor: '#videoDate', content: '13 квіт. 2022 р.' },
            { anchor: '#videoDescription', content: 'Після звірств рускєх терористів-безбожників в Бучі і інших містах України багато хто почав говорити, що нам треба свій Моссад. Я впевнений, що більшість не цікавилися історією цієї структури. Тому підготував для вас спецвипуск.' },
            { anchor: '#videoContainer iframe', prop: 'src', content: 'https://www.youtube.com/embed/UQgWVbwxjYg' }
        ]
    },
    {
        ...
        content: video,
        extraBindings: [
            { anchor: '#videoDate', content: '3 квіт. 2022 р.' },
            { anchor: '#videoDescription', content: 'Спецвипуск про Інформаційно-психологічні операції проти нас. Частина 2. Риторику ворога змінено на «деукраїнізацію». Це ніщо інакше, як фашизм і нацизм. Проти України йде велика і довгострокова дезінформаційна операція. Що це таке і з чого складається?' },
            { anchor: '#videoContainer iframe', prop: 'src', content: 'https://www.youtube.com/embed/HCiXjjY-OvA' }
        ]
    },
    {
        ...
        extraBindings: [
            { anchor: '#videoDate', content: '3 квіт. 2022 р.' },
            { anchor: '#videoDescription', content: 'Спецвипуск про Інформаційно-психологічні операції проти нас. Частина 1. Найпоширеніші методи впливу на українців окупантом. Головне - якщо ви знаєте хоча б поверхнево про ІПсО - на вас вже складніше вплинути.' },
            { anchor: '#videoContainer iframe', prop: 'src', content: 'https://www.youtube.com/embed/HqF6S1IIW4s' }
        ]
    },
    {
        ...
        content: video,
        extraBindings: [
            { anchor: '#videoDate', content: '27 бер. 2022 р.' },
            { anchor: '#videoDescription', content: 'УТОЧНЕННЯ:<br> Аміак - легший за повітря ⬆️ <br> Хлор - важчий ⬇️' },
            { anchor: '#videoContainer iframe', prop: 'src', content: 'https://www.youtube.com/embed/EpF-wCTfPcU' }
        ]
    }
]
